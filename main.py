  ...
  FloatLayout:
    MDScrollView:
      ...
      MDList:
        ...
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q2"
          text: "Quiz 2"
          IconLeftWidget:
            icon: "account-hard-hat"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q3"
          text: "Quiz 3"
          IconLeftWidget:
            icon: "brain"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q4"
          text: "Quiz 4"
          IconLeftWidget:
            icon: "arrow-down"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q5"
          text: "Quiz 5"
          IconLeftWidget:
            icon: "hammer"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q6"
          text: "Quiz 6"
          IconLeftWidget:
            icon: "hammer"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q7"
          text: "Quiz 7"
          IconLeftWidget:
            icon: "hammer"
        OneLineAvatarIconListItem:
          on_release: 
            root.screen_manager.current = "q8"
          text: "Quiz 8"
          IconLeftWidget:
            icon: "hammer"
